...
"Custom Syntax
syntax match LLDBDiArrow '->'
syntax match LLDBDiBlackout '.\[\d\+m\>'
syntax match LLDBDiAddress /\<0x\x\+\>/
syntax match LLDBDiOffset /<+\?\d\+>/

highlight default link LLDBDiArrow Statement
highlight default link LLDBDiAddress Constant
highlight default link LLDBDiOffset Number
highlight LLDBBlackout ctermfg=233
